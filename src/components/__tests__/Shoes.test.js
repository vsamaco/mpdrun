...
const shoesData = [
  { id: 1, brand_name: 'Saucony', model_name: 'Endorphin Speed', name: 'Saucony Endorphin Speed', distance: 1000 }
]
...
describe('Shoes', () => {
  ...
  it('renders shoes', () => {
    ...
    expect(within(shoes[0]).getByText(/Endorphin Speed/i)).toBeInTheDocument();
