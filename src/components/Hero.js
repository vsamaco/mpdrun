  ...
  return (
    <div className="py-10 px-5 sm:py-20 sm:px-10 flex flex-col justify-center">
      ...
      <div className="text-4xl sm:text-6xl opacity-50 flex flex-col pb-32">
        <a href="#run" className="hover:underline text-yellow-300 uppercase">RUN</a>
        <a href="#week" className="hover:underline text-blue-300">WEEK</a>
        <a href="#shoes" className="hover:underline text-green-300">SHOES</a>
